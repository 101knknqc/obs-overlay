...
const setLanguage = (lang) => {
    ...
    masterTeamA.name = masterTeamA.name === translations.fr.teamA ? trans.teamA : masterTeamA.name;
    masterTeamB.name = masterTeamB.name === translations.fr.teamB ? trans.teamB : masterTeamB.name;
...
document.addEventListener('DOMContentLoaded', () => {
    const savedLang = localStorage.getItem('scoreboardLang') || 'fr';
